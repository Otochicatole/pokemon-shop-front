...
export async function deleteShippingZone(id: string) { await adminFetch(`/admin/fulfillment/shipping-zones/${id}`, { method: 'DELETE' }); }
...
export async function deletePickupPoint(id: string) { await adminFetch(`/admin/fulfillment/pickup-points/${id}`, { method: 'DELETE' }); }
