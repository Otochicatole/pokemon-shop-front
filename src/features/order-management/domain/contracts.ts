...
const itemSchema = z.object({ id: z.string(), productId: z.string().nullable(), sku: z.string(), name: z.string(), imageFileId: z.string().nullable(), imageUrl: z.string().nullable(), unitPrice: moneySchema, quantity: z.number().int(), lineTotal: moneySchema, snapshot: z.unknown() });
...
const sellerOrderItemSchema = z.object({ id: z.string(), productId: z.string().nullable(), name: z.string(), quantity: z.number().int(), unitPrice: moneySchema, lineTotal: moneySchema });
